...
/**
 * desde aqui se podran modificar ciertos datos de la empresa
 */
public class AjustesEmpresaFragment extends Fragment {
    Button editar,  buscar;
    private EditText campoContrasena, campoNombre, campoPrecioFotocopia, campoDireccion, campoTelefono;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.ajustes_empresa_fragment, container, false);
        ...
        buscar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                campoCorreo.setText(Variables.correoEmpresa);
                buscar(propiedades.getProperty("url") + "buscarEmpresa.php?correo="+ Variables.correoEmpresa +"");
            }
        });
        editar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ejecutarActualizacion(propiedades.getProperty("url") + "actualizarEmpresa.php?correo="+ Variables.correoEmpresa +"");
    ...
    private void ejecutarActualizacion(String URL) {
        ...
        StringRequest cadenaRespuesta = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                if(campoPrecioFotocopia.getText().toString().contains(" cent/hoja")){
                    fotocopia=campoPrecioFotocopia.getText().toString();
                }else{
                    fotocopia=campoPrecioFotocopia.getText().toString()+" cent/hoja";
                }
                parametros.put("precioFotocopia", fotocopia);
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        campoPrecioFotocopia.setText(jsonObject.getString("precioFotocopia"));
